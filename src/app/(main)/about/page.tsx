  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-6">
      <div className="border-b border-gray-150 pb-5">
        ...
        <p className="text-gray-500 text-sm mt-1">Welcome to WearixBD, your trusted online destination for stylish and affordable men's fashion in Bangladesh.</p>
      </div>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm space-y-6 text-sm text-gray-600 leading-relaxed text-justify">
        ...
        <div>
          <h3 className="font-bold text-gray-900 text-lg mb-3">Welcome to WearixBD</h3>
          <p className="mb-3">At WearixBD, we believe that great style should be accessible to everyone. Our goal is to provide high-quality fashion products at competitive prices while ensuring a smooth and reliable shopping experience.</p>
        ...
        <div className="pt-4 border-t border-gray-100">
          <h3 className="font-bold text-gray-900 text-lg mb-3">Why Choose WearixBD?</h3>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <div className="pt-4 border-t border-gray-100">
          ...
          <p className="mt-2 text-blue-600 font-bold">Thank you for choosing WearixBD.</p>
        </div>
